...
<head>
  ...
  <title>Trang Admin - Đánh giá & Nhận xét</title>
          ...
          <div class="card-body">
            ...
            <div class="text-end mb-4">
              <a href="?seen=all" class="btn btn-dark rounded-pill shadow-none btn-sm">
                <i class="bi bi-check-all"></i> Đọc hết
              </a>
                ...
                <tbody>
                  <?php 
                    ...
                    while($row = mysqli_fetch_assoc($data))
                    {
                      ...
                      $seen='';
                      if($row['seen']!=1){
                        $seen = "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-primary mb-2'>Tích để đọc</a> <br>";
                      }
