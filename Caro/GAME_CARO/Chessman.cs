...
namespace GAME_CARO
{
    public class Chessman//lớp quân cờ
    {
        ...
        public void drawChessmanPlayerA(PaintEventArgs e, Chessman chessman)//vẽ quân cờ màu đỏ trên bàn cờ - vẽ hình tròn
        {
        ...
        public void drawChessmanPlayerB(PaintEventArgs e, Chessman chessman) //vẽ quân cờ màu xanh trên bàn cờ - vẽ chữ x
        {
